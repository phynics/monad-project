...
public actor SessionManager {
    ...
    public init(persistenceService: any PersistenceServiceProtocol, embeddingService: any EmbeddingService, llmService: any LLMServiceProtocol) {
    ...
    public func createSession(title: String = "New Conversation") async throws -> ConversationSession {
        ...
        let toolManager = await createToolManager(for: session, documentManager: documentManager, toolContextSession: toolContextSession, jobQueueContext: jobQueueContext)
    ...
    private func createToolManager(
        ...
        return SessionToolManager(availableTools: availableTools, contextSession: toolContextSession)
    }

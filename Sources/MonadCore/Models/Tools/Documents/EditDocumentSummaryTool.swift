...
public struct EditDocumentSummaryTool: Tool, @unchecked Sendable {
    public let id = "edit_document_summary"
    public let name = "Edit Document Summary"
    public let description = "Edit the summary or notes for a loaded document. Useful for tracking analysis or intent."

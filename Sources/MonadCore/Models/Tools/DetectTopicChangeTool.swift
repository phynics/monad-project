...
public struct DetectTopicChangeTool: Tool, Sendable {
    public let id = "mark_topic_change"
    public let name = "Mark Topic Change"
    public let description =
        "Signal that the conversation topic has changed. Use this when the user shifts focus to a completely new subject."
        ...
        return [
            ...
            "properties": [
                ...
                "summary": [
                    "type": "string",
                    "description":
                        "A brief summary of the previous topic discussion (max 250 words).",
                ],
                "reason": [
                    "type": "string",

...
public final class EditNoteTool: Tool, Sendable {
        ...
        return [
            ...
            "properties": [
                ...
                "line_index": [
                    "type": "integer",
                    "description":
                        "Line number to replace (0-indexed). Use -1 to append. If provided, performs line-based edit.",
                ],
                "mode": [
                    "type": "string",
                    "enum": ["overwrite", "append", "replace_line"],
                    "description":
                        "Explicit edit mode. 'overwrite' replaces entire content. 'append' adds to end. 'replace_line' requires line_index.",
                ],
            ],
    ...
    public func execute(parameters: [String: Any]) async throws -> ToolResult {
        guard let noteName = parameters["note_name"] as? String,
            let newContent = parameters["content"] as? String
        else {
        ...
        if let idx = lineIndex {
            ...
            if !updatedNote.content.trimmingCharacters(in: .whitespacesAndNewlines).hasSuffix(

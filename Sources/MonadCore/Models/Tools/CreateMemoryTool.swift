...
public final class CreateMemoryTool: Tool, @unchecked Sendable {
    ...
    public func execute(parameters: [String: Any]) async throws -> ToolResult {
        ...
        do {
            ...
            let savedId = try await persistenceService.saveMemory(memory, policy: .preventSimilar(threshold: 0.92))
            ...
            if savedId == memory.id {
                ...
                return .success("Memory creation skipped: A semantically similar memory already exists.")
            }
        } catch {

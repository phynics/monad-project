...
public struct SearchNotesTool: Tool, Sendable {
        ...
        return [
            ...
            "properties": [
                "query": [
                    "type": "string",
                    "description":
                        "Search query to find in notes (searches name, description, and content)",
                ],
                "tags": [
                    "type": "array",
                    "items": ["type": "string"],
    ...
    public func execute(parameters: [String: Any]) async throws -> ToolResult {
        ...
        do {
            ...
            let results: String = allNotes.prefix(10).map { note in
                ...
                let tagsStr =
                    note.tagArray.isEmpty ? "" : " [Tags: \(note.tagArray.joined(separator: ", "))]"

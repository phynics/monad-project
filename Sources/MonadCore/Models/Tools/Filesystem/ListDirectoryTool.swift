...
public struct ListDirectoryTool: Tool, @unchecked Sendable {
    public let id = "ls"
    ...
    public var parametersSchema: [String: Any] {
        return [
            ...
            "properties": [
                "path": [
                    "type": "string",
                    "description": "The path to the directory (defaults to current directory if omitted)"
                ]
            ]
        ]
    }
    ...
    public func execute(parameters: [String: Any]) async throws -> ToolResult {
        ...
        do {
            ...
            let formattedContents = contents.map { fileURL -> String in
                ...
                let sizeString = isDir ? "" : ByteCountFormatter.string(fromByteCount: Int64(size), countStyle: .file)

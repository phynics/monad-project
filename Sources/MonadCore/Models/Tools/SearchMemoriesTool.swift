...
public final class SearchMemoriesTool: Tool, Sendable {
        ...
        do {
            ...
            if let query = query, !query.isEmpty {
                ...
                let semanticResults = try await persistenceService.searchMemories(
                    embedding: embedding, limit: 5, minSimilarity: 0.4)
            ...
            let formattedResults = allMemories.map { $0.promptString }.joined(
                separator: "\n\n---\n\n")

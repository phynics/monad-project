...
public actor OpenRouterClient: Sendable {
    ...
    public init(
        ...
        logger.debug("Initialized OpenRouterClient with model: \(modelName), endpoint: \(urlString)")
    }
    ...
    public func chatStream(
        ...
        logger.debug("OpenRouter chat stream started for model: \(self.modelName) at \(chatURL.absoluteString)")

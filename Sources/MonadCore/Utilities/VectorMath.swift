...
public enum VectorMath {
    ...
    /// - Returns: The magnitude (0.0 if empty)
    ...
    /// Calculate cosine similarity between two vectors using a pre-calculated magnitude for the first vector.
    /// This is an optimization for scenarios where one vector (like a query) is compared against many others.
    /// - Parameters:
    ///   - vectorA: First vector
    ///   - vectorB: Second vector
